...
//===----------------------------------------------------------------------===//
#ifndef NITETRICHOR_TYPE_TRAITS_HPP
#define NITETRICHOR_TYPE_TRAITS_HPP
...
struct is_trivially_copy_constructible
    : std::is_copy_constructible<
              ::AN::detail::copy_construction_triviality_helper<T>> {};
template <typename T>
...
struct is_trivially_move_constructible
    : std::is_move_constructible<
              ::AN::detail::move_construction_triviality_helper<T>> {};
template <typename T>
...
#endif//NITETRICHOR_TYPE_TRAITS_HPP
